import re
import requests
from definitions import Script, NUMBER_REGEX
...
class AMD(Script):
    ...
    REV_REGEX = re.compile('quarter of 2020 of \\$[0-9]+\\.[0-9]+ billion')
    ...
    def get_report(self):
        ...
        self.report = PdfConverter.convert_pdf_to_txt('report.pdf')
        report_file.close()
    ...
    def parse_EPS(self):
        res = self.EPS_REGEX.search(self.report).group()
